...
let imgBaseUrl ='https://image.tmdb.org/t/p/w500';
 async function getAllTerndings(MediaType,callback){
    ...
    let {data} =await axios.get(`https://api.themoviedb.org/3/trending/${MediaType}/day?api_key=eba8b9a7199efdcb0ca1f96879b83c44&fbclid=IwAR2kArrFYlDYF7UV-44Zl3L5UI9sH1UgIXv9N4SrIzcIZb070ZVCbCgfR7A`);
  ...
  return (
   ...
   <div className="row">
    ...
    <div onClick={()=>getDetalis(movie.id)} key={movie.id} className="col-md-2 gy-3">
      ...
      <span>{Math.floor( movie.vote_average)}<i class="fa-solid fa-star"></i></span>  
      </div>
      </div>
...
<div className="row">
    ...
    <div onClick={()=>getActorDetalis(pepole.id)}   key={pepole.id} className="col-md-2 gy-3">
      <div className="actorsDisplay ">
        <img src={imgBaseUrl+pepole.profile_path} className='w-100'  />
